...
public class USDNNeighborCoordinatesMessage extends USDNMessage {
    private List<NodeCoordinates> neighbors;
    private SensorNodeAddress nodeAddress;

    @SuppressWarnings("Message type")
    public USDNNeighborCoordinatesMessage(SensorNodeAddress sink, SensorNodeAddress nodeAddress) {
