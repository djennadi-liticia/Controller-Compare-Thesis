...
public class USDNnodeId {

    public static final String SCHEME = "usdn";

    private byte[] addr;
    private int netId;

    public USDNnodeId(int netId, byte[] addr) {
        this.netId = netId;
    ...
    public static USDNnodeId fromMacAddress(MacAddress macAddress) {
        ...
        return new USDNnodeId(netId, addr);
    }
    public static USDNnodeId fromUri(URI uri) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof USDNnodeId)) {
            return false;
        }

        USDNnodeId that = (USDNnodeId) o;
