...
public class USDNNodeCoordinatesMessage extends USDNMessage {
    ...
    public USDNNodeCoordinatesMessage(byte[] payload) {
        nofCoordinates = 0;
        if (payload.length >= 2) {
    ...
    public USDNNodeCoordinatesMessage(SensorNodeAddress sink, SensorNodeAddress nodeAddress,
...
//        super.setMessageType(SensorMessageType.MULTICAST_GEO_COORDINATES);
        ...
        super.setDestination(new USDNnodeId(nodeAddress.getNetId(), nodeAddress.getAddr()));
...
//        super.setMessageType(SensorMessageType.MULTICAST_GEO_COORDINATES);
    ...
    public USDNnetworkPacket getNetworkPacket() {
        USDNnetworkPacket networkPacket = super.getNetworkPacket();
